...
- `react-google-login` (package is no longer maintained): [npm](https://www.npmjs.com/package/react-google-login), [github](https://github.com/anthonyjgrove/react-google-login)
