...
- ❤️ `connectFile.ts` - A utility to bind a file to a variable using WeakMap and Proxy. (Private: Used in `qr-solution` project)
- ❤️ `filedb.js` ([private](https://github.com/sahilrajput03/config/blob/main/snips/js-node/filedb.js))
