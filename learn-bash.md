# 🚀🚀🚀 In PROCESS OF MIGRATION TO [THIS DOC](https://docs.google.com/document/d/1o2UE4d3E5nMvfoaQP2_3G-dPjjf1719h8uLRltn3C1w/edit?tab=t.e75nn9rhxa2x#heading=h.v67slhjr85f1)
...
# --- WAY 1 --- Importing file relative to current script file path
source "$SCRIPT_DIR/variables.sh"

# --- WAY 2 --- changing directory to run a command from path relative to current script path
cd $SCRIPT_DIR/..
sops -e .env > enc.env
